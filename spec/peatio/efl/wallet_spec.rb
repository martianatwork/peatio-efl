RSpec.describe Peatio::Efl::Wallet do
  let(:wallet) { Peatio::Efl::Wallet.new }
  ...
  context :configure do
    let(:unconfigured_wallet) { Peatio::Efl::Wallet.new }
    ...
    it 'sets settings attribute' do
      ...
      expect(unconfigured_wallet.settings).to eq(settings.slice(*Peatio::Efl::Wallet::SUPPORTED_SETTINGS))
    end
  end
